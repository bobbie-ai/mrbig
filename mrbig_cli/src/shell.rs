// ############################################################################
// #                                                                          #
// # mrbig_cli/src/shell.rs                                                   #
// #                                                                          #
// # Handcrafted with love by MrBig Mobsters                                  #
// # All rights reserved                                                      #
// #                                                                          #
// #                                                                          #
// # Description: Fancy shell functions.                                      #
// ############################################################################

//! Shell functions
//!
//! Colorized terminal output with emojis and progress bar. This shell is
//! thread-safe.
...
impl std::str::FromStr for LogLevel {
  ...
  type Err = crate::errors::CliError;
  ...
  fn from_str(s: &str) -> StdResult<Self, Self::Err> {
    match s {
      ...
      _      => Err(crate::errors::CliError::UnknownLogLevel)
    }
  }
}

/// Fancy shell for printing messages.
pub struct Shell {
  quiet: AtomicBool,
  log_level: AtomicU8,
}
